...
from ff4f00_http.header import Headers, Header
from ff4f00_http.io.bytes import ByteReader, ByteWriter
...
fn run_benchmark():
    try:
        ...
        var m = Bench(config)
        m.bench_function[ff4f00_benchmark_header_encode](BenchId("HeaderEncode"))
        m.bench_function[ff4f00_benchmark_header_parse](BenchId("HeaderParse"))
        m.bench_function[ff4f00_benchmark_request_encode](BenchId("RequestEncode"))
        m.bench_function[ff4f00_benchmark_request_parse](BenchId("RequestParse"))
        m.bench_function[ff4f00_benchmark_response_encode](BenchId("ResponseEncode"))
        m.bench_function[ff4f00_benchmark_response_parse](BenchId("ResponseParse"))
        m.dump_report()
    except:
...
@parameter
fn ff4f00_benchmark_response_encode(mut b: Bencher):
    @always_inline
    @parameter
    fn response_encode():
...
@parameter
fn ff4f00_benchmark_response_parse(mut b: Bencher):
    @always_inline
    @parameter
    fn response_parse():
        try:
...
@parameter
fn ff4f00_benchmark_request_parse(mut b: Bencher):
    @always_inline
    @parameter
    fn request_parse():
        try:
...
@parameter
fn ff4f00_benchmark_request_encode(mut b: Bencher):
    @always_inline
    @parameter
...
@parameter
fn ff4f00_benchmark_header_encode(mut b: Bencher):
    @always_inline
    @parameter
    fn header_encode():
        var b = ByteWriter()
...
@parameter
fn ff4f00_benchmark_header_parse(mut b: Bencher):
    @always_inline
    @parameter
    fn header_parse():
        try:
